...
public class PropertyUtils implements EnvironmentAware {
    ...
    @Override
    public void setEnvironment(Environment parEnvironment) {
    	PropertyUtils.setEnvironmentStatic(parEnvironment);
    }
    
    public static void setEnvironmentStatic(Environment parEnvironment) {
    	PropertyUtils.environment = parEnvironment;
    }
