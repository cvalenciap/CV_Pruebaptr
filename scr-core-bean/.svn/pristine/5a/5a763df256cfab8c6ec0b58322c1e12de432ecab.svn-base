...
/**
 * The Class AlmacenamientoPTAPBean.
 */
public class AlmacenamientoPTAPBean  extends BaseBean implements Serializable {
	...
	/**
	 * Gets the str usuario creacion.
	 *
	 * @return the str usuario creacion
	 */
	...
	/**
	 * Sets the str usuario creacion.
	 *
	 * @param strUsuarioCreacion the new str usuario creacion
	 */
	...
	/**
	 * Gets the str fecha creacion.
	 *
	 * @return the str fecha creacion
	 */
	...
	/**
	 * Sets the str fecha creacion.
	 *
	 * @param strFechaCreacion the new str fecha creacion
	 */
	...
	/**
	 * Gets the str usuario modificacion.
	 *
	 * @return the str usuario modificacion
	 */
	...
	/**
	 * Sets the str usuario modificacion.
	 *
	 * @param strUsuarioModificacion the new str usuario modificacion
	 */
	 ...
	 *
	 * @return the str fecha modificacion
	 */
	 ...
	 *
	 * @param strFechaModificacion the new str fecha modificacion
	 */
	...
	/**
	 * Gets the str nom programa.
	 *
	 * @return the str nom programa
	 */
	...
	/**
	 * Sets the str nom programa.
	 *
	 * @param strNomPrograma the new str nom programa
	 */
	...
	/**
	 * Gets the int id hide.
	 *
	 * @return the int id hide
	 */
	...
	/**
	 * Sets the int id hide.
	 *
	 * @param intIdHide the new int id hide
	 */
	...
	/**
	 * Gets the str hora muestreo.
	 *
	 * @return the str hora muestreo
	 */
	...
	/**
	 * Sets the str hora muestreo.
	 *
	 * @param strHoraMuestreo the new str hora muestreo
	 */
	...
	/**
	 * Gets the str fecha recepcion muestra.
	 *
	 * @return the str fecha recepcion muestra
	 */
	...
	/**
	 * Sets the str fecha recepcion muestra.
	 *
	 * @param strFechaRecepcionMuestra the new str fecha recepcion muestra
	 */
	...
	/**
	 * Gets the str hora recepcion muestra.
	 *
	 * @return the str hora recepcion muestra
	 */
	...
	/**
	 * Sets the str hora recepcion muestra.
	 *
	 * @param strHoraRecepcionMuestra the new str hora recepcion muestra
	 */
	...
	/**
	 * Gets the str fecha inicio ensayo.
	 *
	 * @return the str fecha inicio ensayo
	 */
	...
	/**
	 * Sets the str fecha inicio ensayo.
	 *
	 * @param strFechaInicioEnsayo the new str fecha inicio ensayo
	 */
	...
	/**
	 * Gets the str hora inicio ensayo.
	 *
	 * @return the str hora inicio ensayo
	 */
	...
	/**
	 * Sets the str hora inicio ensayo.
	 *
	 * @param strHoraInicioEnsayo the new str hora inicio ensayo
	 */
	 ...
	 * Sets the str turno.
	 *
	 * @param strTurno the new str turno
	 */
	...
	/**
	 * Gets the str muestreador.
	 *
	 * @return the str muestreador
	 */
	...
	/**
	 * Sets the str muestreador.
	 *
	 * @param strMuestreador the new str muestreador
	 */
	...
	/**
	 * Gets the str analista.
	 *
	 * @return the str analista
	 */
	...
	/**
	 * Sets the str analista.
	 *
	 * @param strAnalista the new str analista
	 */
	 ...
	 * Sets the int estado.
	 *
	 * @param intEstado the new int estado
	 */
	...
	/**
	 * Gets the int mant conexiones hide.
	 *
	 * @return the int mant conexiones hide
	 */
	...
	/**
	 * Sets the int mant conexiones hide.
	 *
	 * @param intMantConexionesHide the new int mant conexiones hide
	 */
	...
	/**
	 * Gets the int cumplimiento LBD hide.
	 *
	 * @return the int cumplimiento LBD hide
	 */
	...
	/**
	 * Sets the int cumplimiento LBD hide.
	 *
	 * @param intCumplimientoLBDHide the new int cumplimiento LBD hide
	 */
	...
	/**
	 * Checks if is bol cumplimiento LBD.
	 *
	 * @return true, if is bol cumplimiento LBD
	 */
	...
	/**
	 * Sets the bol cumplimiento LBD.
	 *
	 * @param bolCumplimientoLBD the new bol cumplimiento LBD
	 */
	...
	/**
	 * Checks if is bol mant conexiones.
	 *
	 * @return true, if is bol mant conexiones
	 */
	...
	/**
	 * Sets the bol mant conexiones.
	 *
	 * @param bolMantConexiones the new bol mant conexiones
	 */
	...
	/**
	 * Gets the str muestreador hide.
	 *
	 * @return the str muestreador hide
	 */
	...
	/**
	 * Sets the str muestreador hide.
	 *
	 * @param strMuestreadorHide the new str muestreador hide
	 */
	...
	/**
	 * Gets the str analista hide.
	 *
	 * @return the str analista hide
	 */
	...
	/**
	 * Sets the str analista hide.
	 *
	 * @param strAnalistaHide the new str analista hide
	 */
	...
	/**
	 * Gets the int id form.
	 *
	 * @return the int id form
	 */
	...
	/**
	 * Sets the int id form.
	 *
	 * @param intIdForm the new int id form
	 */
	...
	/**
	 * Gets the str observacion.
	 *
	 * @return the str observacion
	 */
	...
	/**
	 * Sets the str observacion.
	 *
	 * @param strObservacion the new str observacion
	 */
