...
public interface IAnalistaService {
	...
	Integer registrarParametrosxAnalista(List<ParametroPtarSectorBean>  ltaParametrosxAnalista,Integer idAnalista,BaseSptarBean auditoria) throws GmdException;	
