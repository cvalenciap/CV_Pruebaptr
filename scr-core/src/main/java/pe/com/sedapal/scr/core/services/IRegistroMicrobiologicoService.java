...
public interface IRegistroMicrobiologicoService {
	...
	List<RegistroMicrobiologicoBean> obtenerRegistroMicrobiologicoByPtarPuntoMuestraSecundario(Integer idPtarxSector, Integer idParametro) throws GmdException;
}