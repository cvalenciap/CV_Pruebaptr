...
@Repository
public class RegistroMicrobiologicoDaoImpl implements IRegistroMicrobiologicoDao {
	...
	public List<RegistroMicrobiologicoBean> obtenerRegistroMicrobiologicoByRegLaboratorio(Integer idRegLab) throws GmdException {
		...
		caller.withCatalogName(ConstantesSptar.PCK_SPTAR_RLAB_MBIOLOGICO).withProcedureName(ConstantesSptar.PRC_LIST_RLAB_MBIOLOGICO)
				.declareParameters(	
						...
						new SqlOutParameter(
								ConstantesSptar.PAR_OUT_CURSOR, OracleTypes.CURSOR, new RowMapper<RegistroMicrobiologicoBean>() {
									...
									public RegistroMicrobiologicoBean mapRow(ResultSet rs, int rowNum) throws SQLException {
										...
										record.setNumEC24(rs.getDouble(20));
										record.setNumEC48(rs.getDouble(21));
										record.setIdTuboDilucionCLV48(rs.getInt(22));
										record.setDescripcionTuboDilucionCLV48(rs.getString(23));
										record.setNumValorCT(rs.getDouble(24));
										record.setNumCTNMP(rs.getString(25));
										record.setValorDecimalCLV48(rs.getDouble(26));
										record.setIdTuboDilucionEC48(rs.getInt(27));
										record.setDescripcionTuboDilucionEC48(rs.getString(28));
										record.setNumValorCTTNMP(rs.getDouble(29));
										record.setNumCTTNMP(rs.getString(30));
										record.setValorDecimalEC48(rs.getDouble(31));
										record.setIdAnalista(rs.getInt(32));
										record.setFechaMonitoreo(rs.getDate(33));
										record.setFechaRegDato(rs.getDate(34));
										record.setIntervaloMinimo(rs.getString(35) != null && !Strings.isBlank(rs.getString(35)) && !rs.getString(35).equals(" ") ? Double.parseDouble(rs.getString(35)) : null );
										record.setIntervaloMaximo(rs.getString(36) != null && !Strings.isBlank(rs.getString(36)) && !rs.getString(36).equals(" ") ? Double.parseDouble(rs.getString(36)) : null );
										record.setNombreAnalista(rs.getString(38));
										record.setFlagMejorValor(rs.getInt(40));
										return record;										
									}
								}))
	...
	public RegistroMicrobiologicoBean registrarRegistroMicrobiologico(RegistroMicrobiologicoBean registroMicrobiologico) throws GmdException {
		...
		try {
			...
			paramsInput.add(new SqlParameter(ConstantesSptar.PAR_N_NUM_EC24, OracleTypes.DECIMAL));
			paramsInput.add(new SqlParameter(ConstantesSptar.PAR_N_NUM_EC48, OracleTypes.DECIMAL));
			...
			paramsInput.add(new SqlParameter(ConstantesSptar.PAR_N_ID_TUBO_EC48, OracleTypes.DECIMAL));
			paramsInput.add(new SqlParameter(ConstantesSptar.PAR_N_VAL_EC48, OracleTypes.DECIMAL));
			paramsInput.add(new SqlParameter(ConstantesSptar.PAR_V_VAL_EC48, OracleTypes.VARCHAR));
			paramsInput.add(new SqlParameter(ConstantesSptar.PAR_N_DEC_EC48, OracleTypes.DECIMAL));
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), ConstantesSptar.PCK_SPTAR_RLAB_MBIOLOGICO+ConstantesSptar.P_SEPARADOR+ConstantesSptar.PRC_REGI_RLAB_MBIOLOGICO, 
			...
			inputs.put(ConstantesSptar.PAR_N_NUM_EC24, registroMicrobiologico.getNumEC24());
			inputs.put(ConstantesSptar.PAR_N_NUM_EC48, registroMicrobiologico.getNumEC48());
			...
			inputs.put(ConstantesSptar.PAR_N_ID_TUBO_EC48, registroMicrobiologico.getIdTuboDilucionEC48());
			inputs.put(ConstantesSptar.PAR_N_VAL_EC48, registroMicrobiologico.getNumValorCTTNMP());
			inputs.put(ConstantesSptar.PAR_V_VAL_EC48, registroMicrobiologico.getNumCTTNMP());
			inputs.put(ConstantesSptar.PAR_N_DEC_EC48, registroMicrobiologico.getValorDecimalEC48());
	...
	public void actualizarRegistroMicrobiologico(RegistroMicrobiologicoBean registroMicrobiologico) throws GmdException {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), ConstantesSptar.PCK_SPTAR_RLAB_MBIOLOGICO+ConstantesSptar.P_SEPARADOR+ConstantesSptar.PRC_ACTU_RLAB_MBIOLOGICO, 
					environment.getRequiredProperty(ConstantesSptar.ORACLE_PROCEDURES_SCHEMA), paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
	...
	public void anularRegistroMicrobiologico(RegistroMicrobiologicoBean registroMicrobiologico) throws GmdException {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), ConstantesSptar.PCK_SPTAR_RLAB_MBIOLOGICO+ConstantesSptar.P_SEPARADOR+ConstantesSptar.PRC_ELIM_RLAB_MBIOLOGICO,// 
					environment.getRequiredProperty(ConstantesSptar.ORACLE_PROCEDURES_SCHEMA), paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
			inputs.put(ConstantesSptar.PAR_N_ID_MICROBIOLOGICO, registroMicrobiologico.getIdRegMicrobiologico());
	...
	public List<RegistroMicrobiologicoBean> obtenerRegistroMicrobiologicoByidMicrobiologico(Integer idMicrobiologico,Date fechaDesde,Date FechaHasta) throws GmdException {
		List<RegistroMicrobiologicoBean> lstRetorno = null;
		SimpleJdbcCall caller = new SimpleJdbcCall(template.getDataSource());
		caller.withCatalogName(ConstantesSptar.PCK_SPTAR_RLAB_MBIOLOGICO).withProcedureName(ConstantesSptar.PRC_BUSCAR_RLAB_MBIOLOGICO)
				.declareParameters(	
	...
	public void aprobarRegistroMicrobiologico(RegistroMicrobiologicoBean registroMicrobiologico) throws GmdException {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), ConstantesSptar.PCK_SPTAR_RLAB_MBIOLOGICO+ConstantesSptar.P_SEPARADOR+ConstantesSptar.PRC_APROB_RLAB_MBIOLOGICO, 
					environment.getRequiredProperty(ConstantesSptar.ORACLE_PROCEDURES_SCHEMA), paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
			inputs.put(ConstantesSptar.PAR_N_ID_REGISTRO, registroMicrobiologico.getIdRegLaboratorio());
			inputs.put(ConstantesSptar.PAR_V_ST_REGI, registroMicrobiologico.getStRegi());
	...
	public void eliminarGrupoRegistroMicrobiologico(Integer idRegistroLaboratorio, Integer grupo, BaseSptarBean auditoria) throws GmdException{
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), ConstantesSptar.PCK_SPTAR_RLAB_MBIOLOGICO+ConstantesSptar.P_SEPARADOR+ConstantesSptar.PRC_ELIM_RLAB_MBIO_GRP, 
					environment.getRequiredProperty(ConstantesSptar.ORACLE_PROCEDURES_SCHEMA), paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();
	...
	public void actualizarMejorValorMicrobiologico(RegistroMicrobiologicoBean registroMicrobiologico) throws GmdException {
		...
		try {
			...
			this.execSp = new ExecuteProcedure(template.getDataSource(), ConstantesSptar.PCK_SPTAR_RLAB_MBIOLOGICO+ConstantesSptar.P_SEPARADOR+ConstantesSptar.PRC_ACTU_MV_MBIOLOGICO, 
					environment.getRequiredProperty(ConstantesSptar.ORACLE_PROCEDURES_SCHEMA), paramsInput, paramsOutput);
			inputs = new HashMap<String, Object>();			
			inputs.put(ConstantesSptar.PAR_N_ID_MICROBIOLOGICO, registroMicrobiologico.getIdRegMicrobiologico());
			inputs.put(ConstantesSptar.PAR_N_FLG_MEJOR_VALOR, registroMicrobiologico.getFlagMejorValor());
