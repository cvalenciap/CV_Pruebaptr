...
/**
 * The Interface IReporteAlmacenamientoPTAPService.
 */
public interface IReporteAlmacenamientoPTAPService {

	/**
	 * Actualizar reporte almacenamiento PTAP resul.
	 *
	 ...
	 *
	 * @param reporteAlmacenamientoPTAPBean the reporte almacenamiento PTAP bean
	...
	/**
	 * Obtener datos PTAP result table.
	 *
	 * @param reporteAlmacenamientoPTAPBean the reporte almacenamiento PTAP bean
	 * @return the reporte almacenamiento PTAP bean
	 * @throws Exception the exception
	 */
