...
/**
 * The Interface PuntoXSubactividadDao.
 */
public interface PuntoXSubactividadDao {

	/**
	 * Actualizar punto X subactividad.
	 *
	 * @param puntoXSubactividad the punto X subactividad
	 */
	public void actualizarPuntoXSubactividad(PuntoXSubactividad puntoXSubactividad);
	
	/**
	 * Insertar punto X subactividad.
	 *
	 * @param puntoXSubactividad the punto X subactividad
	 */
	...
	/**
	 * Existe punto X subactividad.
	 *
	 * @param idSubactividad the id subactividad
	 * @param idPunto the id punto
