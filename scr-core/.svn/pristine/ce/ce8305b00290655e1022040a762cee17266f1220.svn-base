...
/**
 * The Interface IAlmacenamientoPTAPService.
 */
public interface IAlmacenamientoPTAPService {

	/**
	 * Obtener datos almacenamiento PTAP.
	 *
	 * @param almacenamientoPTAPBean the almacenamiento PTAP bean
	...
	/**
	 * Obtener datos table first.
	 *
	 * @param almacenamientoPTAPFirstBean the almacenamiento PTAP first bean
	 * @param paginacion the paginacion
	 * @return the result
	 * @throws Exception the exception
	 */
	...
	/**
	 * Obtener datos table second.
	 *
	 * @param almacenamientoPTAPSecondBean the almacenamiento PTAP second bean
	 * @param paginacion the paginacion
	 * @return the result
	 * @throws Exception the exception
	 */
	...
	/**
	 * Obtener datos table three.
	 *
	 * @param almacenamientoPTAPThreeBean the almacenamiento PTAP three bean
	 * @param paginacion the paginacion
	 * @return the result
	 * @throws Exception the exception
	 */
	 ...
	 * @throws Exception the exception
	 */
	int calcularTablaFirst(AlmacenamientoPTAPFirstBean almacenamientoPTAPFirstBean) throws Exception;
