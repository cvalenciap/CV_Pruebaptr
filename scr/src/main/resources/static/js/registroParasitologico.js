...
function confirmacionGuardarObservacionParasitologico(){
	var tituloModal = 'Observacion Registro Parasitológico';
	modal.confirmer('¿Esta seguro de Grabar la Observación del Registro?', 'guardarObservacionParasitologico()', 'regresarObservacionParasitologico()', tituloModal);
}
